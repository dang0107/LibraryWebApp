<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_registration.aspx.cs" Inherits="LibraryWebApp.user.user_registration" %>
...
<div class="login">
  ...
  <form id="f1" runat="server">
    ...
    <p>
        <asp:Button ID="b1" runat="server" Text="Register" class="submit" OnClick="b1_Click"></asp:Button>
    </p>
      <div>
          <p>
              Already have account ? <a href="/user/user_login.aspx" >Sign in</a>
          </p>
      </div>
  </form>
</div>
