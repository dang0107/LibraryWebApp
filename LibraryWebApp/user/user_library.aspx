<%@ Page Title="" Language="C#" MasterPageFile="~/user/User.Master" AutoEventWireup="true" CodeBehind="user_library.aspx.cs" Inherits="LibraryWebApp.user.user_library" %>
            ...
            <asp:Repeater ID="r1" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="borrow_books.aspx?id=<%#Eval("id")%>">Borrow</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
